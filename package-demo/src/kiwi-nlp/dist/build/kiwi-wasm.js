var kiwi = (() => {
    ...
    return (async function (moduleArg = {}) {
        ...
        function createWasm() { var info = getWasmImports(); function receiveInstance(instance, module) { wasmExports = instance.exports; wasmMemory = wasmExports["I"]; updateMemoryViews(); wasmTable = wasmExports["L"]; addOnInit(wasmExports["J"]); removeRunDependency("wasm-instantiate"); return wasmExports; } addRunDependency("wasm-instantiate"); function receiveInstantiationResult(result) { receiveInstance(result["instance"]); } if (Module["instantiateWasm"]) {
            try {
        ...
        var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, ErrnoError: class {
                ...
                fd = FS.nextfd();
            } stream.fd = fd; FS.streams[fd] = stream; return stream; }, closeStream(fd) { FS.streams[fd] = null; }, dupStream(origStream, fd = -1) { var _a, _b; var stream = FS.createStream(origStream, fd); (_b = (_a = stream.stream_ops) === null || _a === void 0 ? void 0 : _a.dup) === null || _b === void 0 ? void 0 : _b.call(_a, stream); return stream; }, chrdev_stream_ops: { open(stream) { var _a, _b; var device = FS.getDevice(stream.node.rdev); stream.stream_ops = device.stream_ops; (_b = (_a = stream.stream_ops).open) === null || _b === void 0 ? void 0 : _b.call(_a, stream); }, llseek() { throw new FS.ErrnoError(70); } }, major: dev => dev >> 8, minor: dev => dev & 255, makedev: (ma, mi) => ma << 8 | mi, registerDevice(dev, ops) { FS.devices[dev] = { stream_ops: ops }; }, getDevice: dev => FS.devices[dev], getMounts(mount) { var mounts = []; var check = [mount]; while (check.length) {
                var m = check.pop();
                mounts.push(m);
                check.push(...m.mounts);
                ...
                FS.createDevice.major = 64; var dev = FS.makedev(FS.createDevice.major++, 0); FS.registerDevice(dev, { open(stream) { stream.seekable = false; }, close(stream) { var _a; if ((_a = output === null || output === void 0 ? void 0 : output.buffer) === null || _a === void 0 ? void 0 : _a.length) {
                    output(10);
        ...
        var wasmImports = { a: ___cxa_throw, h: ___syscall_fcntl64, F: ___syscall_fstat64, x: ___syscall_ioctl, D: ___syscall_newfstatat, j: ___syscall_openat, E: ___syscall_stat64, y: __abort_js, s: __embind_register_bigint, l: __embind_register_bool, d: __embind_register_constant, H: __embind_register_emval, g: __embind_register_float, n: __embind_register_function, c: __embind_register_integer, b: __embind_register_memory_view, k: __embind_register_std_string, f: __embind_register_std_wstring, m: __embind_register_void, G: __emscripten_memcpy_js, o: __emval_decref, t: __emval_incref, B: __emval_new_cstring, q: __mmap_js, r: __munmap_js, v: __tzset_js, u: _emscripten_get_heap_max, z: _emscripten_resize_heap, A: _environ_get, C: _environ_sizes_get, e: _fd_close, w: _fd_read, p: _fd_seek, i: _fd_write };
        ...
        var _emscripten_builtin_memalign = (a0, a1) => (_emscripten_builtin_memalign = wasmExports["O"])(a0, a1);
        var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["P"])(a0);
        var dynCall_viijii = Module["dynCall_viijii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viijii = Module["dynCall_viijii"] = wasmExports["Q"])(a0, a1, a2, a3, a4, a5, a6);
