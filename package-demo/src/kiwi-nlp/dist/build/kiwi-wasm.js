var kiwi = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function abort(what) {
      var _a;
      (_a = Module["onAbort"]) === null || _a === void 0
        ? void 0
        : _a.call(Module, what);
      what = "Aborted(" + what + ")";
      err(what);
    ...
    var FS = {
      ...
      dupStream(origStream, fd = -1) {
        ...
        (_b =
          (_a = stream.stream_ops) === null || _a === void 0
            ? void 0
            : _a.dup) === null || _b === void 0
          ? void 0
          : _b.call(_a, stream);
        return stream;
      },
      chrdev_stream_ops: {
        open(stream) {
          ...
          (_b = (_a = stream.stream_ops).open) === null || _b === void 0
            ? void 0
            : _b.call(_a, stream);
        },
        llseek() {
    ...
    var stringToUTF16 = (str, outPtr, maxBytesToWrite) => {
      maxBytesToWrite !== null && maxBytesToWrite !== void 0
        ? maxBytesToWrite
    ...
    function run() {
      ...
      function doRun() {
        ...
        (_a = Module["onRuntimeInitialized"]) === null || _a === void 0
          ? void 0
          : _a.call(Module);
        postRun();
      }
