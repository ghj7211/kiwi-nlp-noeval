...
export interface Kiwi {
     ...
     */
    analyze: (str: string, matchOptions?: Match, blockList?: Morph[] | MorphemeSet, pretokenized?: PretokenizedSpan[]) => TokenResult;
    /**
     ...
     */
    analyzeTopN: (str: string, n: number, matchOptions?: Match, blockList?: Morph[] | MorphemeSet, pretokenized?: PretokenizedSpan[]) => TokenResult[];
    /**
     ...
     */
    tokenize: (str: string, matchOptions?: Match, blockList?: Morph[] | MorphemeSet, pretokenized?: PretokenizedSpan[]) => TokenInfo[];
    /**
     ...
     */
    tokenizeTopN: (str: string, n: number, matchOptions?: Match, blockList?: Morph[] | MorphemeSet, pretokenized?: PretokenizedSpan[]) => TokenInfo[][];
    /**
